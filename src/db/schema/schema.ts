...
export const posts = pgTable(
  ...
  (table) => ({
    ...
    visibilityIdx: index('idx_posts_visibility').on(table.visibility, table.authorId),
  }),
);
...
export const likes = pgTable(
  ...
  (table) => ({
    ...
    uniqueLike: uniqueIndex('uq_likes_user_target').on(
      table.userId,
      table.targetId,
      table.targetType,
    ),
...
/**
 * PASSWORD_RESET_TOKENS table - Stores password reset tokens for forgot password flow
 */
export const passwordResetTokens = pgTable(
  ...
  (table) => ({
    tokenHashIdx: uniqueIndex('uq_password_reset_token_hash').on(table.tokenHash),
